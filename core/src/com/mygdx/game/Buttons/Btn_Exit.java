...
public class Btn_Exit extends Button {
    ...
    public Btn_Exit(float x, float y) {
        super(x, y, 64, 64, SprNames.btn_exit.name());
    ...
    @Override
    public void onTouch() {
        if (GameEngine.gameState.isLevelSelection() || GameEngine.gameState.isScoresScreen() && Gdx.input.justTouched()) {
